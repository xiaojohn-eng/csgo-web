...
const dir = path.resolve(process.argv[2] ?? '.reference-assets/source-exports/pistol-candidates/glock-world');
...
assert(weaponSkin, 'Expected exact original pistol world skin');
