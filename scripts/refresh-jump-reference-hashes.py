"""Refresh the frozen reference hashes after the jump_lower snapshot merge.

scripts/patch-source-jump-snapshots.py appended the original a_jump* FRAMEANIM
descriptors to every research snapshot body dataset (existing descriptors keep
...
- the M4 actor-reference.json poseDataSHA256 (mirrors the production manifest
  entry for pose-data.json after scripts/merge-source-jump-poses.py).
"""
...
print('JUMP_REFERENCE_REFRESH_DONE')
