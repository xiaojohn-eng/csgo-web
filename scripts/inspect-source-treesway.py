"""Original App740 TREESWAY selector, constants and real-prop token fixtures.
...
OUT = ROOT / '.reference-assets/source-exports/dust2-foliage-audit/treesway'
VHV = ROOT / '.reference-assets/source-exports/dust2-vhv'
NAMES = ['palm_frond_01', 'sumac_01']
...
def main():
    ...
    parameters = [1, 100, .5, 200, 0, .2, 0, .25, 1.2, .5, 2, 2, 3, 200, 600, 0]
    ...
    assert count == 70 and max_zero_wind == 0 and max_color_error < 2e-6
    evidence = {'format': 'source-treesway-oracle-v1', 'binary': shader.identity(), 'selectorCases': selections,
        ...
        'nativeConstantSentinels': sentinel, 'originalPalmSumacParameterValues': parameters, 'nativeConstants': constants,
