...
const dir = path.resolve(process.argv[2] ?? '.reference-assets/source-exports/ak47');
...
const weaponSkin = doc.skins.find(s => s.joints.some(n => doc.nodes[n].name === 'v_weapon.ak47_parent'));
assert(weaponSkin, 'Expected the original AK47 skin');
